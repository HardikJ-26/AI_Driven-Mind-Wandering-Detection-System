...
This report is based on the specified introduction, Experiment 1–3, Experiment 4, and real-time-detection presentation material, plus `experiment4_detailed_report.md`. PAFE experimentation and unrelated Experiment 1–3 material are excluded.
